...
/*
SNMPApiService Get SNMP Servers
Get list of SNMP hosts for alert notification
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InlineResponse20016
*/
func (a *SNMPApiService) GetSNMPhosts(ctx context.Context) (InlineResponse20016, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/V4/Snmp"
