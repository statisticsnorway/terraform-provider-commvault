...
*/
func (a *LoginApiService) Login(ctx context.Context, localVarOptionals *LoginOpts) (LoginResponseCustomerManaged, *http.Response, error) {
	return prepareAndCallApiJSON[LoginResponseCustomerManaged](ctx, a.client, http.MethodPost, "/login", nil, &localVarOptionals)
}
