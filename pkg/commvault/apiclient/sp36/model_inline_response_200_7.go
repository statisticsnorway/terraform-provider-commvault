...
type InlineResponse2007 struct {
	TotalNoOfAlerts int32 `json:"totalNoOfAlerts,omitempty"`
	NumberOfNewAlert int32 `json:"numberOfNewAlert,omitempty"`
	FeedsList []interface{} `json:"feedsList,omitempty"`
}
