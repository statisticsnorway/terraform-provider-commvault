...
// Create a Virtualization replication group with the destination as Amazon vendor.
type CreateReplicationGroupAmazon struct {
	DestVendor string `json:"destVendor"`
	AdvancedOptions *ReplicationGroupAdvOptionsAmazon `json:"advancedOptions,omitempty"`
	...
	OverrideReplicationOptions []OverrideReplicationOptionsAmazonCreate `json:"overrideReplicationOptions,omitempty"`
