...
// Create a Virtualization replication group with the destination as HyperV vendor
type CreateReplicationGroupHyperV struct {
	DestVendor string `json:"destVendor"`
	AdvancedOptions *ReplicationGroupAdvOptionsHyperV `json:"advancedOptions,omitempty"`
	...
	OverrideReplicationOptions []OverrideReplicationOptionsHyperVCreate `json:"overrideReplicationOptions,omitempty"`
