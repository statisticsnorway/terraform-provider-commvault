...
**ServerName** | **string** | Xen hostname  | [optional] [default to null]
**UserName** | **string** | Xen userName  | [optional] [default to null]
**Password** | **string** | Xen password  | [optional] [default to null]
