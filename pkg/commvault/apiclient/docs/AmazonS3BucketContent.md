...
**Authentication** | **string** | Authentication type for the cloud storage server | [optional] [default to null]
**ArnRole** | **string** | Needed for AWS STS assume role and AWS STS assume role with IAM role policy | [optional] [default to null]
