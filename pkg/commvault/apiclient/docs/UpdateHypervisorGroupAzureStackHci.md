...
**ClusterName** | **string** | Azure Stack HCI cluster name  | [optional] [default to null]
**UserName** | **string** | Azure Stack HCI userName  | [optional] [default to null]
**Password** | **string** | Azure Stack HCI password  | [optional] [default to null]
