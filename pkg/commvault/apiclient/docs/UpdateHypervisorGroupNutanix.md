...
**HostName** | **string** | Nutanix hostname  | [optional] [default to null]
**UserName** | **string** | Nutanix userName  | [optional] [default to null]
**Password** | **string** | Nutanix password  | [optional] [default to null]
